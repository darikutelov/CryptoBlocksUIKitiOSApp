...
class BlocksTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(forName: .blocksDataLoaded,
                                               object: nil,
                                               queue: nil) { _ in
                self.loadData()
        }
    ...
    override func tableView(_ tableView: UITableView,
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "blocksReusableCell",
                                                       for: indexPath) as? BlockTableViewCell else {
